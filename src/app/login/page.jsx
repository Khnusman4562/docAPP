export default function Login(){
    return(
        <div className="flex justify-center items-center bg-green-200 h-[100vh] p-8">
            <div className="bg-white shadow-2xl p-8 text-center h-auto w-full lg:h-[60%] lg:w-[22%] rounded-4xl flex flex-col gap-8">
